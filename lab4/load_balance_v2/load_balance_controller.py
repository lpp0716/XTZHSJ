...
def main(p4info_file_path, bmv2_file_path):
    ...
    try:
        ...
        ["10.0.0.1", 32], {"ecmp_base": 0, "ecmp_count": 4})
        ...
        writeNextHop(p4info_helper, s1, s1,
        1, {"nhop_dmac": "00:00:00:00:01:03", "nhop_ipv4": "10.0.2.2", "port": 3})
        writeNextHop(p4info_helper, s1, s1,
        2, {"nhop_dmac": "00:00:00:00:01:04", "nhop_ipv4": "10.0.2.2", "port": 4})
        writeNextHop(p4info_helper, s1, s1,
        3, {"nhop_dmac": "00:00:00:00:01:05", "nhop_ipv4": "10.0.2.2", "port": 5})
        ...
        writeDMAC(p4info_helper, s1, s1,
        4, {"smac": "00:00:00:01:04:00"})
        writeDMAC(p4info_helper, s1, s1,
        5, {"smac": "00:00:00:01:05:00"})
        
        # s2 流规则下发
        writeHashRange(p4info_helper, s2, s2, 
        ["10.0.2.2", 32], {"ecmp_base": 0, "ecmp_count": 1})
        writeNextHop(p4info_helper, s2, s2,
        0, {"nhop_dmac": "00:00:00:00:02:02", "nhop_ipv4": "10.0.2.2", "port": 2})
        writeDMAC(p4info_helper, s2, s2,
        1, {"smac": "00:00:00:02:02:00"})
        
        # s3 流规则下发
        writeHashRange(p4info_helper, s3, s3, 
        ["10.0.2.2", 32], {"ecmp_base": 0, "ecmp_count": 1})
        writeNextHop(p4info_helper, s3, s3,
        0, {"nhop_dmac": "00:00:00:00:03:02", "nhop_ipv4": "10.0.2.2", "port": 2})
        writeDMAC(p4info_helper, s3, s3,
        1, {"smac": "00:00:00:03:02:00"})

        # s4 流规则下发
        writeHashRange(p4info_helper, s4, s4, 
        ["10.0.2.2", 32], {"ecmp_base": 0, "ecmp_count": 1})
        writeNextHop(p4info_helper, s4, s4,
        0, {"nhop_dmac": "00:00:00:00:04:02", "nhop_ipv4": "10.0.2.2", "port": 2})
        writeDMAC(p4info_helper, s4, s4,
        1, {"smac": "00:00:00:04:02:00"})

        # s5 流规则下发
        writeHashRange(p4info_helper, s5, s5, 
        ["10.0.2.2", 32], {"ecmp_base": 0, "ecmp_count": 1})
        writeNextHop(p4info_helper, s5, s5,
        0, {"nhop_dmac": "00:00:00:00:05:02", "nhop_ipv4": "10.0.2.2", "port": 2})
        writeDMAC(p4info_helper, s5, s5,
        1, {"smac": "00:00:00:05:02:00"})

        # s6 流规则下发
        writeHashRange(p4info_helper, s6, s6, 
        ["10.0.2.2", 32], {"ecmp_base": 0, "ecmp_count": 1})
        writeNextHop(p4info_helper, s6, s6,
        0, {"nhop_dmac": "08:00:00:00:02:02", "nhop_ipv4": "10.0.2.2", "port": 1})
        writeDMAC(p4info_helper, s6, s6,
        1, {"smac": "00:00:00:06:01:00"})        
